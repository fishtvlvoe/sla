...
```bash
curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/smart-llm-agents/main/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/smart-llm-agents/main/uninstall.sh | bash
```
